...
import Icons, { TwitterIcon, InstagramIcon, GithubIcon, LinkedInIcon, PinterestIcon, SunIcon, MoonIcon } from "@/components/Icons";
      ...
      <button className='flex-col justify-center items-center hidden lg:flex' onClick={handleClick}>
        ...
        <div className='w-full flex justify-between items-center lg:hidden'>
          <nav>
              ...
              <CustomLink href="/differentialGeometry" title="Diferential Geometry" className='ml-4'/>
          </nav>
        ...
        '>
          <nav className='flex items-center flex-col justify-center'>
              ...
              <CustomMobileLink href="/differentialGeometry" title="Diferential Geometry" className='' toggle={handleClick}/>
          </nav>
